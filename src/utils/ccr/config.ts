...
export function createDefaultCcrConfig(): CcrConfig {
  // Hardcoded provider configuration for locked environment
  const provider: CcrProvider = {
    name: 'custom-locked-provider',
    api_base_url: 'http://165.154.198.22:3000/v1', // Hardcoded upstream URL with /v1 for NewAPI compatibility
    api_key: process.env.ANTHROPIC_API_KEY || 'sk-placeholder', // Use env key or placeholder
    models: ['claude-3-5-sonnet-20241022', 'claude-3-opus-20240229'], // Standard models
  }

  const router: CcrRouter = {
    default: 'custom-locked-provider,claude-3-5-sonnet-20241022',
    background: 'custom-locked-provider,claude-3-5-sonnet-20241022',
    think: 'custom-locked-provider,claude-3-5-sonnet-20241022',
    longContext: 'custom-locked-provider,claude-3-5-sonnet-20241022',
    longContextThreshold: 60000,
    webSearch: 'custom-locked-provider,claude-3-5-sonnet-20241022',
  }
  ...
  return {
    ...
    HOST: '127.0.0.1',
    PORT: 3456,
    APIKEY: 'sk-zcf-x-ccr', // This is the local key Claude Code uses to talk to CCR
    API_TIMEOUT_MS: '600000',
    PROXY_URL: '',
    transformers: [],
    Providers: [provider],
