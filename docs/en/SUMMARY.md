...
* [CCometixLine Status Bar](features/cometix.md)
* [Multi-Config and Backup](features/multi-config.md)
...
* [Uninstall and Cleanup](cli/uninstall.md)
* [Config Switch](cli/config-switch.md)
* [Version Check](cli/check-updates.md)
...
* [Git Smart Commands](workflows/git-commands.md)

## Best Practices
* [Best Practices](best-practices/index.md)
* [Usage Tips](best-practices/tips.md)
* [Worktree Parallel Development](best-practices/worktree.md)
* [Output Style Strategy](best-practices/output-styles.md)

## Development Documentation
* [For Contributors](development/index.md)
